...
public class JdbcPizzaRepositoryTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void update() {
		...
		assertEquals(0, BigDecimal.ONE.compareTo(super.jdbcTemplate.queryForObject("select prijs from pizzas where id=?", BigDecimal.class, id)));
	}
	...
	@Test
	public void findUniekePrijzenGeeftPrijznOplopend() {
